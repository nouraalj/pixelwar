...
data = np.loadtxt('testTileVariable_time1.txt')
...
plt.title('Boîte à moustaches du délai d\'attente en fonction de la taille de la tuile (variable) pour la stratégie GiantLock')
plt.xticks(rotation=45) 
plt.savefig("../plot/time/tileVariableSize1.png")
