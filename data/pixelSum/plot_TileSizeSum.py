...
donnees = np.loadtxt('testTileSize_sum.txt')
...
plt.title('Débit de pixels posés en fonction de la taille de la tuile')
plt.xlabel('Taille de tuile')
plt.ylabel('Débit de pixels posés')
plt.legend()

# Afficher le graphique
plt.grid(True)
plt.savefig("../plot/pixelSum/tileSize.png")
