...
data = np.loadtxt('testImgSize_timeCS2.txt')
...
plt.title('Boîte à moustaches de la durée de la section critique en fonction de la taille de l\'image pour la stratégie InterLock')
plt.xticks(rotation=45) 
plt.savefig("../plot/time/imgCSInter.png")
